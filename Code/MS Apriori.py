...
def inputfile():
    del transactionList[:]
    t = []
    inputFile = open(r'C:\Users\Ashwin PC\Desktop\MS Materials\Data Mining and text mining\Project - 1\Test data\p1\data2.txt','r')
...
def paramfile():
    param = []
    parameterFile = open(r'C:\Users\Ashwin PC\Desktop\MS Materials\Data Mining and text mining\Project - 1\Test data\p1\para2-2.txt','r')
